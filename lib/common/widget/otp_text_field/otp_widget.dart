// ignore_for_file: must_be_immutable, use_build_context_synchronously, prefer_const_constructors, library_private_types_in_public_api

import 'package:blog/common/widget/gradient_input_boder.dart';
...
class _OtpTextFieldState extends State<OtpTextField> {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        style: AppTextStyle.headerStyle
            .copyWith(color: AppColors.greyColor3, fontSize: 18),
  ...
  void changeFocusToPreviousNodeWhenTapBackspace() async {
    ...
    try {
      ...
      logError('Cannot focus on the previous field');
    }
  }
